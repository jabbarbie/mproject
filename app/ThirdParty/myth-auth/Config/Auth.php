...
class Auth extends BaseConfig
{
    ...
    public $views = [
        ...
        'forgot' => 'App\Views\login\forgot',
        'reset' => 'App\Views\login\reset',
        'emailForgot' => 'App\Views\login\emails\forgot',
        'emailActivation' => 'App\Views\login\emails\activation',
    ];
    ...
    public $viewLayout = 'App\Views\login\layout';
    ...
    public $personalFields = ['id_cabang','group_id'];
